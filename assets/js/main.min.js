...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _blogform = __webpack_require__(30);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	*/
	'use strict';var aa=__webpack_require__(1),l=__webpack_require__(14),B=__webpack_require__(15),C=__webpack_require__(6),ba=__webpack_require__(16),da=__webpack_require__(17),ea=__webpack_require__(18),fa=__webpack_require__(19),ia=__webpack_require__(22),D=__webpack_require__(5);
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            'a',
	                            { href: '#', className: 'header-menu-item header-menu-item--active' },
	                            'React Blog'
	                        ),
	                        _react2.default.createElement(
	                            'a',
	                            { href: '#', className: 'header-menu-item' },
	                            'One'
	                        ),
	                        _react2.default.createElement(
	                            'a',
...
/***/ (function(module, exports, __webpack_require__) {
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(FooterNav, { footernav: footernav })
	                        ),
	                        _react2.default.createElement(
	                            'div',
	...
	function FooterNav(props) {
	    var nav = props.footernav.map(function (post) {
	        return _react2.default.createElement(
	            'div',
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var BlogForm = function (_Component) {
	    ...
	    function BlogForm(props) {
	        ...
	        _this.BlogTitle = _this.BlogTitle.bind(_this);
	        _this.SearchText = _this.SearchText.bind(_this);
	        _this.BlogText = _this.BlogText.bind(_this);
	        _this.BlogAuthor = _this.BlogAuthor.bind(_this);
	        _this.BlogImage = _this.BlogImage.bind(_this);
	    ...
	    _createClass(BlogForm, [{
	        ...
	        value: function deleteItem(e) {
	            this.setState({
	                blogList: this.state.blogList.filter(function (note) {
	                    return note.id !== e;
	                })
	            });
	        }
	        ...
	        key: "BlogTitle",
	        value: function BlogTitle(e) {
	            this.setState({ title: e.target.value });
	        }
	    }, {
	        key: "BlogText",
	        value: function BlogText(e) {
	            this.setState({ text: e.target.value });
	        }
	    }, {
	        key: "BlogAuthor",
	        value: function BlogAuthor(e) {
	            this.setState({ author: e.target.value });
	        }
	    }, {
	        key: "BlogImage",
	        value: function BlogImage(e) {
	        ...
	        value: function SearchText(e) {
	            ...
	            this.setState({
	                blogList: this.state.searchList.filter(function (item) {
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        "form",
	                        { action: "#", onSubmit: this.AddBlog },
	                        _react2.default.createElement(
	                            "div",
	                            { className: "input-wrap" },
	                            _react2.default.createElement("input", { type: "text", placeholder: 'Post Title', onChange: this.BlogTitle,
	                                value: this.state.title, required: true }),
	                            _react2.default.createElement("input", { type: "text", placeholder: 'Post Author', onChange: this.BlogAuthor,
	                                value: this.state.author, required: true })
	                        ),
	                        _react2.default.createElement("textarea", { cols: "30", rows: "30", placeholder: 'Post Text', onChange: this.BlogText,
	                            value: this.state.text, required: true }),
	                        "Image URL - ",
	                        _react2.default.createElement(
	                            "span",
	                            null,
	                            "use this one to test 'https://reactjs.org/logo-og.png'"
	                        ),
	                        _react2.default.createElement("input", { type: "url", onChange: this.BlogImage, placeholder: "Image url for your post",
	                            value: this.state.imageUrl, className: "image-ulr-input", required: true }),
	                        _react2.default.createElement("input", { type: "submit", className: "btn-add-post", value: "Add Post" })
	                    ),
	                    _react2.default.createElement("input", { type: "text", placeholder: 'Search some post title', value: this.state.search,
	                        onChange: this.SearchText, className: "search-input" })
	                ),
	                _react2.default.createElement(BlogList, { blogList: this.state.blogList, onDelete: this.deleteItem })
	            );
	        }
	    }]);
	...
	var BlogList = function (_Component2) {
	    _inherits(BlogList, _Component2);

	    function BlogList(props) {
	        _classCallCheck(this, BlogList);

	        return _possibleConstructorReturn(this, (BlogList.__proto__ || Object.getPrototypeOf(BlogList)).call(this, props));
	    }
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                this.props.blogList.map(function (item, index) {
	                    return _react2.default.createElement(
	                        "div",
	                        { className: "item", key: index, id: item.id },
	                        _react2.default.createElement(
	                            "div",
	                            { className: "image-block" },
	                            _react2.default.createElement("img", { className: "image", src: item.imageUrl })
	                        ),
	                        _react2.default.createElement(
	                            "div",
	                            { className: "title" },
	                        ...
	                        _react2.default.createElement(
	                            "div",
	                            { className: "close-item", onClick: _this3.props.onDelete.bind(_this3, item.id) },
	                            "delete post"
	                        ),
	                        _react2.default.createElement(
	                            "div",
